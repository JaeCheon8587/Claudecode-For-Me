---
name: grill-me
description: 아이디어, 워크플로우, 작업을 구체화하고 검증 및 정리하는 스킬. "grill me", "구체화해줘", "요구사항을 뽑아줘", "내 아이디어 뜯어봐", "stress-test this", "poke holes in my plan" 이라고 하거나, 모호한 아이디어/계획/작업을 구체화할 때 발동한다. 질문-반론-재질문을 반복하며 깊은 이해를 만들고, 최종 Q&A 문서를 생성한다. 모호한 트리거가 왔을 때 사용자가 무언가 구체화하려는 의도이면 이 스킬을 사용한다.
